...
const includedFeatures = [
  'All features in the cloud version',
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Self host or use our cloud solution. No hidden fees. No credit card required.
          </p>
        </div>
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="mt-6 text-base leading-7 text-gray-600">
              Pay once, own it forever. Includes all features, lifetime updates and support, and source code access.
            </p>
