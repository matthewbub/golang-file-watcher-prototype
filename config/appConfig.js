export const appConfig = {
  ...
  socialLinks: [
    { name: 'Facebook', href: 'https://www.facebook.com/iep.utm/' },
    { name: 'Instagram', href: 'https://www.instagram.com/iep.utm/' },
    { name: 'LinkedIn', href: 'https://www.linkedin.com/company/iep-utm/' },
    { name: 'Twitter', href: 'https://twitter.com/iep_utm' },
    { name: 'GitHub', href: 'https://github.com/ninembs-studio' }
  ],
