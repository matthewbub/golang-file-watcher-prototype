...
export const caseStudy = {
  client: 'Localeopia',
  title: 'Unlocking Global Potential with a Locale Touch',
  description:
    'Easily manage locales and provide your the best user experince within your web applications and mobile apps via a single API. ',
  summary: [
    'Easily manage locales and provide your the best user experince within your web applications',
  ],
  logo,
  image: { src: imageHero },
  date: '2023-01',
  service: 'Web development, SaaS, API',
  testimonial: {
